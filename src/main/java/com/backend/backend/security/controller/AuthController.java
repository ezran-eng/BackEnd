...
import com.backend.backend.exception.Mensaje;
...
import com.backend.backend.security.service.PersonaService;
...
public class AuthController {
    ...
    public ResponseEntity<?> nuevo(@Valid @RequestBody NuevoUsuario nuevoUsuario, BindingResult bindingResult){
        ...
        if(personaService.existsByNombreUsuario(nuevoUsuario.getNombreUsuario()))
            return new ResponseEntity(new Mensaje("ese nombre ya existe"), HttpStatus.BAD_REQUEST);
        if(personaService.existsByEmail(nuevoUsuario.getEmail()))
